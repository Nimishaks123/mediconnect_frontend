...
//   };
  ...
  const loadWalletData = async () => {
    ...
    try {
      ...
      const walletData =
        await getDoctorWallet();

      setWallet(walletData);
      

      const txData =
  await getDoctorWalletTransactions(
    page,
    10
  );
...
<p className="mt-2 text-gray-600">
  View your consultation earnings and wallet transactions.
</p>
      </header>
      <div className="mb-6">
    ...
    Add Funds
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-sky-600 to-indigo-700 rounded-3xl p-8 mb-10 shadow-xl shadow-sky-200">
        ...
        <div className="relative z-10">
          <p className="text-sky-100 font-bold uppercase tracking-widest text-xs mb-2">Available Earnings</p>
          ...
          <div className="mt-8 flex gap-4">
             <div className="bg-white/10 backdrop-blur-md rounded-2xl px-4 py-3 flex-1 border border-white/10">
                <p className="text-sky-100 text-[10px] uppercase font-bold tracking-wider mb-1 opacity-80">Payment Status</p>
                <p className="text-white font-bold">Automatically Credited</p>
             </div>
             <div className="bg-white/10 backdrop-blur-md rounded-2xl px-4 py-3 flex-1 border border-white/10">
      ...
      <div>
        ...
        {transactions.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-gray-200 shadow-sm">
            ...
            <p className="text-gray-500 mt-1 max-w-sm mx-auto">Your consultation earnings will appear here once appointments are completed.</p>
          </div>
        ) : (
